...
public class EmployeUploadFinishDocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employe_upload_finish_doc);
        if (getSupportActionBar() != null){
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setDisplayShowHomeEnabled(true);
            getSupportActionBar().setTitle("Upload Finished Documents");
        ...
        clear_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                arrayList.clear();
                MyAdapter mAdapter = new MyAdapter(EmployeUploadFinishDocActivity.this, arrayList);
                ...
                if (services.getStatus()) {
                    ...
                    mOrder.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            AlertDialog.Builder mBuilder = new AlertDialog.Builder(EmployeUploadFinishDocActivity.this);
...
//                        }
            ...
            public void onResponse(Call<UserDataModel> call, Response<UserDataModel> response) {
                ...
                if (userDataModel != null){
                    if (userDataModel.getStatus()){
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(EmployeUploadFinishDocActivity.this,android.R.layout.simple_dropdown_item_1line,users_names);
                ...
                if (resultCode == RESULT_OK) {
                    if(data.getClipData() != null) {
                        ...
                        try {
                            ...
                            arrayList.add(uri);
                            mAdapter = new MyAdapter(EmployeUploadFinishDocActivity.this, arrayList);
                            listView.setAdapter(mAdapter);
    ...
    private void uploadImagesToServer(String des,String rid,String user_txt,String services_txt) {
        if (InternetConnection.checkConnection(EmployeUploadFinishDocActivity.this)) {
            showProgress();
            ...
            Call<EmployeUploadFinishedDoc> call = RetrofitClient.getmInstance().getApi().employee_upload_finish_documents(size,user_rid,user,services,description,parts);

            call.enqueue(new Callback<EmployeUploadFinishedDoc>() {
                @Override
                public void onResponse(@NonNull Call<EmployeUploadFinishedDoc> call, @NonNull Response<EmployeUploadFinishedDoc> response) {
                    hideProgress();

                    EmployeUploadFinishedDoc addNewUserModel = response.body();
                    ...
                    if (addNewUserModel != null){
                        ...
                        ShowErrorAlert();
                        Toast.makeText(EmployeUploadFinishDocActivity.this,
                ...
                @Override
                public void onFailure(@NonNull Call<EmployeUploadFinishedDoc> call, @NonNull Throwable t) {
                    ShowErrorAlert();
                    hideProgress();
    ...
    private boolean askForPermission() {
        ...
        if (currentAPIVersion >= Build.VERSION_CODES.M) {
            int hasCallPermission = ContextCompat.checkSelfPermission(EmployeUploadFinishDocActivity.this,
                    Manifest.permission.READ_EXTERNAL_STORAGE);
            if (hasCallPermission != PackageManager.PERMISSION_GRANTED) {
                // Ask for permission
                // need to request permission
                if (ActivityCompat.shouldShowRequestPermissionRationale(EmployeUploadFinishDocActivity.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    // explain
                    showMessageOKCancel(
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(EmployeUploadFinishDocActivity.this,
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    // Permission Denied
                    Toast.makeText(EmployeUploadFinishDocActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
    ...
    private void showMessageOKCancel(DialogInterface.OnClickListener okListener) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EmployeUploadFinishDocActivity.this);
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface arg0) {
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(
                        ContextCompat.getColor(EmployeUploadFinishDocActivity.this, android.R.color.holo_blue_light));
                dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(
                        ContextCompat.getColor(EmployeUploadFinishDocActivity.this, android.R.color.holo_red_light));
            }
        });
